...
export default function Sub_division_form() {
    ...
    const handleSubmit = () => {
      ...
      _postApi('/api/sub-division', land, (res) => {
        setLoading(false)
        console.log(res)
        if (res.success) {
  ...
  const [land,setLand]= useState([])
    ...
    const handleAdd2 = () => {
      ...
      registration_particulars: form.registration_particulars,
      Business_location: form.Business_location,
      correspondence_address: form.correspondence_address,
      age: form.age,
      sex: form.sex,
      yes_no: form.yes_no,
      cert_of_occupany_no: form.cert_of_occupany_no,
      plot_no: form.plot_no,
      location: form.location,
      marital_stataus: form.marital_stataus,
      residential: form.residential,
      email: form.email,
      phone_no: form.phone_no,
      local_govt: form.local_govt,
      Annual_income: form.Annual_income,
      Allocated_before: form.Allocated_before,
      Applicant_nationality: form.Applicant_nationality,
      State_of_origin: form.State_of_origin,
      occupation_business: form.occupation_business,
      nature_of_business: form.nature_of_business,
      company_registered_under: form.company_registered_under,
      when_where_occupancy_no: form.when_where_occupancy_no,
      purpose_of_land_use: form.purpose_of_land_use,
      purpose_for_application_required: form.purpose_for_application_required,
      acitivity_intended_to_undertake: form.acitivity_intended_to_undertake,
      type_of_building_erected: form.type_of_building_erected,
      estimated_amount_to_spenr: form.estimated_amount_to_spenr,
      source_financing: form.source_financing,
      proposed_value_of_building_to_be_created: form.proposed_value_of_building_to_be_created,
      annual_income_or_anticipated_income: form.annual_income_or_anticipated_income,
      length_of_term_required: form.length_of_term_required,
      type_of_plot_piece: form.type_of_plot_piece,
      house_location: form.house_location,
      house_type_of_building: form.house_type_of_building,
      do_you_have_biz_in_kano: form.do_you_have_biz_in_kano,
      address_of_local_rep: form.address_of_local_rep,
      do_you_operate_other_location_in_kano: form.do_you_operate_other_location_in_kano,
      power_of_attorney_if_any: form.do_you_operate_other_location_in_kano,
      business_address: form.do_you_operate_other_location_in_kano,
      location_of_land_required: form.do_you_operate_other_location_in_kano,
      do_you_own_a_house: form.do_you_operate_other_location_in_kano,
      reg_of_particular_of_attorney: form.do_you_operate_other_location_in_kano,
      application_date: today,
      type: form.do_you_operate_other_location_in_kano,
      child_file_no:form.child_file_no,
      type:form.type
          }
  ...
  return (
    ...
    <Card className="app_primary_card m-2 shadow p-4">
      ...
      >
        ...
        <div>
          <h5 className="m-0">Sub-division Form</h5>
        </div>
      </div>

      <Row>
      <Col md={6} className="mt-0">
            <label className="input_label">File Number</label>
            <div className="search_input_form">
              <input
                className="input_field"
                value={form.child_file_no}
      ...
      <div>
          ...
          <button className="app_btn mt-3" onClick={handleAdd2}>
            Add
          </button>
